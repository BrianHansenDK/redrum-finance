...
const LinkedinSvg = React.forwardRef((props, ref: React.LegacyRef<SVGSVGElement>) =>(
  <svg viewBox="0 0 1920 1920" {...props} ref={ref}
  xmlns="http://www.w3.org/2000/svg" stroke="#fefefe">
